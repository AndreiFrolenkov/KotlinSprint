...
/*
* Задача 2 к Уроку
* 1. Скопируй решение из задачи 1 в новый файл с задачей
* 2. Теперь необходимо дописать реализацию программы для новых целей. Имитируем логи с сервера.
...
fun main() {
    ...
    val thanksForPurchase: String = "Спасибо за покупку! Будем рады видеть Вас снова."

    println(numberOfOrders)
    println(thanksForPurchase)

    var numberOfStoreEmployees: Int = 2000
//    println(numberOfStoreEmployees)
    numberOfStoreEmployees = 1999
    println(numberOfStoreEmployees)
}