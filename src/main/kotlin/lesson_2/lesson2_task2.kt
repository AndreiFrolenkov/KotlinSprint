...
fun main() {
    ...
    val employeesAndTrainees = employees + trainee

    val totalEmployeesSalary = employees * employeeSalary
    println(totalEmployeesSalary)
    val totalEmployeesAndTraineesSalary = totalEmployeesSalary + trainee * traineeSalary
    println(totalEmployeesAndTraineesSalary)
    val averageSalary = totalEmployeesAndTraineesSalary / employeesAndTrainees
